...
public class TC_007_RF_password_complixity extends basetest {
	@Test
...
//		basic details	------------------------------------------------------------------------------------------
		...
		driver.findElement(By.xpath(loc.getProperty("TS_001_rf_tc_001_PASSWORD")))
				.sendKeys(loc.getProperty("ENTERTS_001_rf_tc_007_PASSWORD"));

		// confirm password
		driver.findElement(By.xpath(loc.getProperty("TS_001_rf_tc_001_CONFIRM_PASSWORD")))
				.sendKeys(loc.getProperty("ENTERTS_001_rf_tc_007_CONFIRM_PASSWORD"));
		...
		driver.findElement(By.xpath(loc.getProperty("TS_001_rf_tc_001_mobile")))
				.sendKeys(loc.getProperty("TS_001_rf_tc_001_enter_mobile"));
