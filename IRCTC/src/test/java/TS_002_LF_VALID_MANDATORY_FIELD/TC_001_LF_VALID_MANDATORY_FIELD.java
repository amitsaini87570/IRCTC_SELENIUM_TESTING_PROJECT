...
public class TC_001_LF_VALID_MANDATORY_FIELD extends basetest {
	...
	public void LOGIN_FIELDS() throws InterruptedException, TesseractException, IOException {
		...
		driver.findElement(By.xpath(loc.getProperty("TS_002_LF_tc_001_PASSWORD")))
				.sendKeys(loc.getProperty("ENTERTS_002_LF_tc_001_PASSWORD"));

	}

	public void getCaptcha1(String imagexpath00, String enter_captcha_box00)
			throws InterruptedException, TesseractException, IOException {

		TC_001_LF_VALID_MANDATORY_FIELD b = new TC_001_LF_VALID_MANDATORY_FIELD();
		b.LOGIN_FIELDS();
	...
	@Test
	public void get_cap() throws InterruptedException, TesseractException, IOException {

		TC_001_LF_VALID_MANDATORY_FIELD a = new TC_001_LF_VALID_MANDATORY_FIELD();
		a.getCaptcha1((loc.getProperty("TS_002_LF_tc_001_image_xpath001")),
				(loc.getProperty("TS_002_LF_tc_001_enter_captcha_box1")));
