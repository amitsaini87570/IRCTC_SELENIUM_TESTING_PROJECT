...
public class TS_004_FAD_TC_010_RESET_EXIXTING_ACCOUNT extends basetest {
	...
	public void exixting_forgot_account_details() {
		

		driver.findElement(By.xpath(loc.getProperty("TS_004_FAD_tc_0001_click_on_LOGIN"))).click();
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);

		// click on forgot account details
		driver.findElement(By.xpath(loc.getProperty("TS_004_FAD_tc_0001click_on_forgot_account_details"))).click();

		// enter email

		driver.findElement(By.xpath(loc.getProperty("TS_004_FAD_tc_0001_EMAIL_USER_ID")))
				.sendKeys(loc.getProperty("ENTER_TS_004_FAD_tc_0001_EMAIL_USER_ID"));

	}

	public void getCaptcha2(String imagexpath00, String enter_captcha_box00) throws InterruptedException {

		TS_004_FAD_TC_010_RESET_EXIXTING_ACCOUNT b = new TS_004_FAD_TC_010_RESET_EXIXTING_ACCOUNT();
		b.exixting_forgot_account_details();
	...
	public void get_cap() throws InterruptedException {
		...
		TS_004_FAD_TC_010_RESET_EXIXTING_ACCOUNT a = new TS_004_FAD_TC_010_RESET_EXIXTING_ACCOUNT();
		a.getCaptcha2((loc.getProperty("TS_004_FAD_tc_0001__image_xpath001")),
				(loc.getProperty("TS_004_FAD_tc_0001_enter_captcha_box1")));

		// click_on_next
		driver.findElement(By.xpath(loc.getProperty("TS_004_FAD_tc_0001_ckick_on_next"))).click();

	}

	
	@Test
	public void reset_password_page() throws IOException, MailosaurException, InterruptedException {

		TS_004_FAD_TC_010_RESET_EXIXTING_ACCOUNT D = new TS_004_FAD_TC_010_RESET_EXIXTING_ACCOUNT();
		D.get_cap();

		// ENTER USERID
		driver.findElement(By.xpath(loc.getProperty("TS_004_FAD_tc_0001_IRCTC_USWR_ID2")))
				.sendKeys(loc.getProperty("ENTER_TS_004_FAD_tc_0001_IRCTC_USWR_ID2"));
