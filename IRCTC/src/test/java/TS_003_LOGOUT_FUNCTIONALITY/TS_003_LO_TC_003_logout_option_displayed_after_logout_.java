...
public class TS_003_LO_TC_003_logout_option_displayed_after_logout_ extends TC_001_LF_VALID_MANDATORY_FIELD {
	@Test
	public void logout() throws InterruptedException, TesseractException, IOException {
		TS_003_LO_TC_003_logout_option_displayed_after_logout_ a = new TS_003_LO_TC_003_logout_option_displayed_after_logout_();
		a.get_cap();
		
		//click on logout
		//driver.findElement(By.xpath(loc.getProperty("TS_003_LO_TC_001_click_on_logout"))).click();

    //logout option not displayed after logout
	}
